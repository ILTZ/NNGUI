...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1160, 484)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.tabWidget_2 = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget_2.setGeometry(QtCore.QRect(0, 0, 1151, 441))
        font = QtGui.QFont()
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(10, 0, 1131, 411))
        ...
        self.doubleSpinBox.setGeometry(QtCore.QRect(20, 30, 62, 22))
        self.doubleSpinBox.setMinimum(0.01)
        self.doubleSpinBox.setMaximum(0.2)
        ...
        self.FAQLearnBox.setGeometry(QtCore.QRect(0, 0, 1021, 411))
        self.FAQLearnBox.setTitle("")
        self.FAQLearnBox.setFlat(False)
        self.FAQLearnBox.setObjectName("FAQLearnBox")
        self.line_6 = QtWidgets.QFrame(self.FAQLearnBox)
        self.line_6.setGeometry(QtCore.QRect(20, 70, 91, 16))
        self.line_6.setFrameShadow(QtWidgets.QFrame.Plain)
        self.line_6.setLineWidth(3)
        self.line_6.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_6.setObjectName("line_6")
        self.line_7 = QtWidgets.QFrame(self.FAQLearnBox)
        self.line_7.setGeometry(QtCore.QRect(20, 120, 91, 16))
        self.line_7.setFrameShadow(QtWidgets.QFrame.Plain)
        self.line_7.setLineWidth(3)
        self.line_7.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_7.setObjectName("line_7")
        self.line_8 = QtWidgets.QFrame(self.FAQLearnBox)
        self.line_8.setGeometry(QtCore.QRect(20, 170, 91, 16))
        self.line_8.setFrameShadow(QtWidgets.QFrame.Plain)
        self.line_8.setLineWidth(3)
        self.line_8.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_8.setObjectName("line_8")
        self.line_9 = QtWidgets.QFrame(self.FAQLearnBox)
        self.line_9.setGeometry(QtCore.QRect(20, 220, 91, 16))
        self.line_9.setFrameShadow(QtWidgets.QFrame.Plain)
        self.line_9.setLineWidth(3)
        self.line_9.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_9.setObjectName("line_9")
        self.line_10 = QtWidgets.QFrame(self.FAQLearnBox)
        self.line_10.setGeometry(QtCore.QRect(20, 270, 91, 16))
        self.line_10.setFrameShadow(QtWidgets.QFrame.Plain)
        self.line_10.setLineWidth(3)
        self.line_10.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_10.setObjectName("line_10")
        self.line_11 = QtWidgets.QFrame(self.FAQLearnBox)
        self.line_11.setGeometry(QtCore.QRect(10, 80, 20, 281))
        self.line_11.setFrameShadow(QtWidgets.QFrame.Plain)
        self.line_11.setLineWidth(3)
        self.line_11.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_11.setObjectName("line_11")
        self.line_12 = QtWidgets.QFrame(self.FAQLearnBox)
        self.line_12.setGeometry(QtCore.QRect(20, 350, 21, 16))
        self.line_12.setFrameShadow(QtWidgets.QFrame.Plain)
        self.line_12.setLineWidth(3)
        self.line_12.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_12.setObjectName("line_12")
        self.label_3 = QtWidgets.QLabel(self.FAQLearnBox)
        self.label_3.setGeometry(QtCore.QRect(40, 300, 231, 91))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.line_13 = QtWidgets.QFrame(self.FAQLearnBox)
        self.line_13.setGeometry(QtCore.QRect(520, 330, 101, 20))
        self.line_13.setFrameShadow(QtWidgets.QFrame.Plain)
        self.line_13.setLineWidth(3)
        self.line_13.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_13.setObjectName("line_13")
        self.label_4 = QtWidgets.QLabel(self.FAQLearnBox)
        self.label_4.setGeometry(QtCore.QRect(620, 270, 231, 121))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.line_14 = QtWidgets.QFrame(self.FAQLearnBox)
        self.line_14.setGeometry(QtCore.QRect(280, 80, 101, 20))
        self.line_14.setFrameShadow(QtWidgets.QFrame.Plain)
        self.line_14.setLineWidth(3)
        self.line_14.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_14.setObjectName("line_14")
        self.label_5 = QtWidgets.QLabel(self.FAQLearnBox)
        self.label_5.setGeometry(QtCore.QRect(380, 50, 231, 81))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.queryFAQBtn.setGeometry(QtCore.QRect(1030, 10, 91, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.groupBoxLink.setGeometry(QtCore.QRect(10, 0, 1131, 401))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.setingsFAQBtn.setGeometry(QtCore.QRect(1030, 10, 91, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.FAQSetingsBox = QtWidgets.QGroupBox(self.groupBoxLink)
        self.FAQSetingsBox.setGeometry(QtCore.QRect(0, 0, 1011, 401))
        self.FAQSetingsBox.setTitle("")
        self.FAQSetingsBox.setObjectName("FAQSetingsBox")
        self.line_15 = QtWidgets.QFrame(self.FAQSetingsBox)
        self.line_15.setGeometry(QtCore.QRect(250, 260, 20, 81))
        self.line_15.setToolTipDuration(3)
        ...
        self.line_16 = QtWidgets.QFrame(self.FAQSetingsBox)
        self.line_16.setGeometry(QtCore.QRect(260, 330, 91, 16))
        self.line_16.setFrameShadow(QtWidgets.QFrame.Plain)
        self.line_16.setLineWidth(3)
        self.line_16.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_16.setObjectName("line_16")
        self.label_6 = QtWidgets.QLabel(self.FAQSetingsBox)
        self.label_6.setGeometry(QtCore.QRect(350, 282, 441, 111))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.performanceBox.setTitle(_translate("MainWindow", "Оценка производительности"))
...
"                и выходным слоем"))
        ...
        self.label_6.setText(_translate("MainWindow", "Между входным и выходным слоем присутствуют еще 2 скрытых слоя.\n"
"Данные параметры определяют, по каким правилам будут генериров-\n"
"аться и сколько весов будут между входным и скрытым, скрытым и \n"
"скрытым, скрытым и выходным нейронами.\n"
"\"Количество связей между скрытым и выходным слоем\" также влияет\n"
"на количетсво выходных значений."))
